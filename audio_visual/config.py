...
args["AUDIO_ONLY_PROBABILITY"] = 0.2    #probability with which to drop only the audio modality
args["VIDEO_ONLY_PROBABILITY"] = 0.2    #probability with which to drop only the video modality
